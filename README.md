# Race2Space Competition Database Query
...
### Deployment
The project can be containerised using Docker and deployed to Azure App Service.

For portfolio demonstration purposes, the frontend and backend can be combined into a single container.
...
│   ├─ app/
│   │   ├─ services/
│   │   │   └─ ml_insights.py       # ML model and chart generation
│   │   └─ api/
│   │       └─ team_insights.py     # FastAPI router exposing team insights
